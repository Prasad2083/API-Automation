...
public class PutMethodTestAPI extends Baseclass {
	...
	public PutMethodTestAPI() throws IOException {
		super();
	...
	public void setup() throws IOException {
		...
		uri=prop.getProperty("MainURLPut");
	...
	public void postmethodapi() throws ClientProtocolException, IOException {
		...
		DataforPutMethod postdata = new DataforPutMethod("Rohith", "Montreal", "122226", "244555", "ghhhh",
		...
		presponse= client.PutMethod(api, postdataintourl, getpostheaders);
		
        int statuscode=presponse.getStatusLine().getStatusCode();
        
        assertEquals(statuscode,Baseclass.Response_200 );
